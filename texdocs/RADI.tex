...
\end{equation}
which requires $c$ moles of dissolved oxygen (\ce{O2}) to completely degrade into \ce{CO2}, \ce{NH3}, \ce{H3PO4} and \ce{H2O}. \wtf{Should it be possible to use a different C:\ce{O2} ratio here?}
