...
permeability=1e-13 # [m^2] typical sediment permeability North Sea [McGinnis et al., 2014]

# Currents
U= 0.07 #m/s

# Define sediment porosity parameters
phiInf = 0.87  # sediment porosity at infinite depth from SM7
phi0 = 0.91  # sediment porosity from SM7
...
P = 440*10.325 # pressure at seafloor / dbar (1atm = 10.1325 dbar )
...
dCH4_w = 0.0e-6
dalk_w = 2432.1e-6  # total alkalinity from GLODAP at station location, bottom waters
dSi_w = 137.9e-6 # total silicate from GLODAP at station location, bottom waters
...
Fpom = 6.0 # flux of POM to seafloor / g/m^2/a, divide by Mpom in Model to get mol/m^2/a
Fpom_r = 0.0  # refractory fraction of POM
Fpom_s = 0.5812283598444857  # slow-degrading fraction of POM
Fpom_f = 0.41877164015551427  # fast-degrading fraction of POM
...
Fcalcite = 0.17  # flux of calcite to the seafloor / mol/m^2/a
