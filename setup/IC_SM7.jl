...
phiInf = 0.87  # sediment porosity at infinite depth
...
T = 0.84  # temperature / degC
S = 34.696  # practical salinity
P = 3932.8  # pressure at seafloor / dbar

# Concentrations all in mol/kg (will be made mol/m3 in the model for ensemble runs where S and T might differ) 
dO2_w = 215.7e-6  # dissolved oxygen from GLODAP at station location, bottom waters
dtCO2_w = 2260e-6  # dissolved inorganic carbon from GLODAP at station location, bottom waters
dtNO3_w = 32.2416e-6  # nitrate from GLODAP at station location, bottom waters
dtSO4_w = (29264.2e-6S/35)  # estimated computed from salinity (Millero, 2013)
dtPO4_w = 2.2428e-6  # total phosphate from GLODAP at station location, bottom waters
dtNH4_w = 0.0  # assumed
dtH2S_w = 0.0  # assumed
...
dalk_w = 2365e-6 # total alkalinity from GLODAP at station location, bottom waters
dSi_w = 120e-6 # total silicate

# Define organic matter flux to the surface sediment
Fpom = 4.6242672045283015  # flux of POM to seafloor / g/m^2/a
...
Fcalcite = 0.25  # flux of calcite to the seafloor / mol/m^2/a
