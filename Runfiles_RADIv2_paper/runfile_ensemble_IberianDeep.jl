...
include("setup/IC_IberianMargin_deep.jl");
...
for i in 1:trajectories
    new_T = 2.5 + rand() * (11.0 - 2.5)
    new_U = 0.01 + rand() * (0.05 - 0.01)
    new_omegaCa = 1.6 + rand() * (4.0 - 1.6)
    new_P = input_P(new_omegaCa, new_T)
    new_Fpom = 3.8 + rand() * (28.55 - 3.8)
    new_Fcalcite = 0.05 + rand() * (0.6 - 0.05)
...
@save "IberianDeep_11_05_2025.jld2" param_meta_list all_sols
