...
include("setup/IC_IberianMargin_shallow.jl");
...
for i in 1:trajectories
    new_T = 11.7 + rand() * (12.8 - 11.7)
    new_U = 0.02 + rand() * (0.08 - 0.02)
    new_omegaCa = 4.13 + rand() * (4.38 - 4.13)
    new_P = input_P(new_omegaCa, new_T)
    new_Fpom = 26.0 + rand() * (55.0 - 26.0)
...
@save "IberianShallow_11_05_2025.jld2" param_meta_list all_sols model_params_list
