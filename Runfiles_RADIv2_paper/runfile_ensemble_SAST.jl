...
include("setup/IC_ArabianSea_SAST.jl");
...
for i in 1:trajectories
    new_T = 1.0 + rand() * (4.0 - 1.0)
    new_U = 0.02 + rand() * (0.06 - 0.02)
    new_omegaCa = 0.98 + rand() * (1.9 - 0.98)
    new_P = input_P(new_omegaCa, new_T)
    new_Fpom = 1.0 + rand() * (12.0 - 1.0)
    new_Fcalcite = 0.1 + rand() * (0.4 - 0.1)
...
@save "SAST_10_05_2025.jld2" param_meta_list all_sols
