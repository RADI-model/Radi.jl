...
const dO2_i = dO2_w  # dissolved oxygen / mol/m^3
const dtCO2_i = dtCO2_w  # dissolved inorganic carbon / mol/m^3
const dtNO3_i = dtNO3_w
const dtSO4_i = dtSO4_w
const dtPO4_i = dtPO4_w
const dtNH4_i = dtNH4_w
const dtH2S_i = dtH2S_w
const dFeII_i = dFeII_w
const dMnII_i = dMnII_w
const dalk_i = dalk_w
const dCa_i = dCa_w
