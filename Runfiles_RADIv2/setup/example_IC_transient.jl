...
run = "IC_IberianMargin_shallow_99_6"
...
lambda_i = 0.065  # for irrigation / m

# Define overlying water column properties
T = 12.5 # (Epping et al., 2002)
S = 35.0  # practical salinity from GLODAP nearest station, bottom waters
P = 103.0 # pressure at seafloor / dbar
rho_sw = gsw_rho(S, T, P) # seawater density / kg/m^3
# Concentrations all in mol/kg
dO2_w = 210.0e-6  # average dissolved oxygen (Epping et al., 2002)
dtCO2_w = 2313.8e-6 # total dissolved inorganic carbon from GLODAP nearest station, bottom waters
dtNO3_w = 9.6e-6 # Epping et al., 2002
...
dtNH4_w = 0.4e-6  # Epping et al., 2002
dtH2S_w = 0.0  #assumed
...
Fpom = 31.64 # flux of POM to seafloor / g/m^2/a (Epping et al., 2002)
Fpom_r = 0.0  # refractory fraction of POM
Fpom_s = 0.2 # slow-degrading fraction of POM
Fpom_f = 0.8 # fast-degrading fraction of POM
