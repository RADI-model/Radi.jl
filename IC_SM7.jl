...
const stoptime = 200.0  # how long to run for
...
const dO2_w = 215.7e-6rho_sw  # dissolved oxygen
const dtCO2_w = 2260e-6rho_sw  # dissolved inorganic carbon
...
const dtPO4_w = 2.2428e-6rho_sw  # total phosphate
...
const Fpom = 3.557128618867924  # flux of POM to seafloor / g/m^2/a
const Fpom_r = 0.1  # refractory fraction of POM
const Fpom_s = 0.25  # slow-degrading fraction of POM
const Fpom_f = 0.65  # fast-degrading fraction of POM
...
const Fcalcite = 0.25 * 0.7  # flux of calcite to the seafloor / mol/m^2/a
const Faragonite = 0.25 * 0.3  # flux of aragonite to the seafloor / mol/m^2/a
